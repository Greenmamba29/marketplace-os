...
import { Sprout, Search, SlidersHorizontal, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
          <h1 className="text-3xl font-display font-bold text-white mb-2">Agricultural Inputs</h1>
          <p className="text-surface-400">Source seeds, fertilizers, and protection products from 420+ suppliers.</p>
        </div>
