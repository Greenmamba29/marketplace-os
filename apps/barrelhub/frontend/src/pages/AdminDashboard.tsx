...
export default function AdminDashboard() {
  const stats = [
    { label: 'Exchange Volume', value: '$112.4M', icon: TrendingUp, color: 'text-accent-success' },
    { label: 'Active Distilleries', value: '280', icon: Users, color: 'text-primary' },
    { label: 'Asset Listings', value: '12k+', icon: Globe, color: 'text-accent-info' },
    { label: 'Escrow Pending', value: '65', icon: ShoppingBag, color: 'text-accent-warning' },
  ];
