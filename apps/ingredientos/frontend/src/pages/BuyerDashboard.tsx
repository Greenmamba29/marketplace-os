...
export default function BuyerDashboard() {
  const stats = [
    { label: 'Active RFQs', value: '4', icon: Package, color: 'text-primary' },
    { label: 'Quotes Received', value: '12', icon: BarChart3, color: 'text-accent-info' },
    { label: 'Order Compliance', value: '99.8%', icon: CheckCircle2, color: 'text-accent-success' },
    { label: 'Total Spent', value: '$24.5k', icon: TrendingUp, color: 'text-white' },
  ];

  const activeRfqs = [
    { id: 'RFQ-001', subject: '2,500 Performance Scrub Sets', status: 'Quoting', date: '2024-03-24', quotes: 3 },
    { id: 'RFQ-002', subject: 'Elite Industrial Safety Vest Order', status: 'Reviewing', date: '2024-03-22', quotes: 5 },
    { id: 'RFQ-003', subject: 'Culinary Master Coat - Sample Batch', status: 'Draft', date: '2024-03-20', quotes: 0 },
  ];
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-display font-bold text-white mb-2">R&D Dashboard</h1>
            <p className="text-surface-400">Welcome back, R&D Director.</p>
          </div>
          <div className="flex gap-3">
            <button className="btn btn-secondary py-2 px-4 text-sm">Tech Documents</button>
            <button className="btn btn-primary py-2 px-4 text-sm">New Inquiry</button>
          </div>
        </div>
