...
from models.network_product import NetworkProduct

router = APIRouter()

@router.get("", response_model=APIResponse[PaginatedResponse[NetworkProduct]])
...
@router.get("/{item_id}", response_model=APIResponse[NetworkProduct])
