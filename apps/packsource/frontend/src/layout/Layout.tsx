...
import { Package, User, LogOut, Menu, X, Search, Bell } from 'lucide-react';
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/" className="flex items-center gap-2">
                ...
                <span className="font-display font-bold text-xl text-white">PackSource</span>
              </Link>
      ...
      <footer className="bg-surface-50 border-t border-surface-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-surface-400 text-sm max-w-sm">
                The global standard for B2B packaging procurement. Source corrugated, plastic, glass, and flexible packaging at scale.
              </p>
            </div>
            <div>
              <h4 className="text-white font-medium mb-4">Platform</h4>
              <ul className="space-y-2 text-sm text-surface-400">
                <li><Link to="/products" className="hover:text-primary transition-colors">Product Directory</Link></li>
                <li><Link to="/rfq" className="hover:text-primary transition-colors">Submit RFQ</Link></li>
          ...
          <div className="mt-12 pt-8 border-t border-surface-200 text-center text-sm text-surface-400">
            © {new Date().getFullYear()} PackSource. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
