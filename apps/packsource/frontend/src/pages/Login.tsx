    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-surface-400">Sign in to manage your packaging procurement.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer text-surface-400">
              <input type="checkbox" className="rounded border-surface-200 text-primary focus:ring-primary bg-surface-50" />
              <span>Remember me</span>
            </label>
            <a href="#" className="text-primary hover:text-primary-400 font-medium">Forgot password?</a>
          </div>
