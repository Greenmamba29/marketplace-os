...
from models.security_product import SecurityProduct

router = APIRouter()

@router.get("", response_model=APIResponse[PaginatedResponse[SecurityProduct]])
...
@router.get("/{item_id}", response_model=APIResponse[SecurityProduct])
