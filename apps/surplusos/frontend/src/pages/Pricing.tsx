      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span
            ...
            style={{ backgroundColor: '#B4530920', color: '#B45309' }}
          >
            PRICING
          </span>
          ...
          <p className="text-lg text-surface-400 max-w-xl mx-auto">
            SurplusOS earns when you earn. Start free, upgrade when you're ready.
          </p>
          {error && (
          ...
          {PLANS.map((plan, i) => (
            ...
            >
              ...
              <ul className="flex-1 space-y-3">
                {plan.features.map((f) => (
                  <li key={f} className="flex items-start gap-2 text-sm text-surface-300">
                    <Check className="w-4 h-4 mt-0.5 shrink-0" style={{ color: '#B45309' }} />
                    {f}
                  </li>
                ))}
              </ul>
              ...
              <button
                ...
                style={plan.highlighted ? { backgroundColor: '#B45309' } : {}}
              >
