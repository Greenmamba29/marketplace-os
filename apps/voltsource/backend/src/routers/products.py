...
from models.energy_component import EnergyComponent

router = APIRouter()

@router.get("", response_model=APIResponse[PaginatedResponse[EnergyComponent]])
...
@router.get("/{item_id}", response_model=APIResponse[EnergyComponent])
