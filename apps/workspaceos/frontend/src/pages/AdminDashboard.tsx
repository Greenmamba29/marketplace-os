...
export default function AdminDashboard() {
  const stats = [
    { label: 'Total Revenue', value: '$1.4M', icon: TrendingUp, color: 'text-accent-success' },
    { label: 'Active Buyers', value: '850', icon: Users, color: 'text-primary' },
    { label: 'Verified Suppliers', value: '420', icon: Globe, color: 'text-accent-info' },
    { label: 'Pending RFQs', value: '18', icon: ShoppingBag, color: 'text-accent-warning' },
  ];
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-display font-bold text-white mb-2">WorkspaceOS Admin</h1>
            <p className="text-surface-400">Manage furniture marketplace operations.</p>
          </div>
          <div className="flex gap-3">
            <button className="btn btn-secondary py-2 px-4 text-sm">Showroom Feed</button>
            <button className="btn btn-primary py-2 px-4 text-sm flex items-center gap-2"><Plus className="w-4 h-4" /> Add Partner</button>
          </div>
        </div>
